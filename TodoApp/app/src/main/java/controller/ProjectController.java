...
public class ProjectController {
    ...
    public List<Project> getAll() {
        ...
        // classe que vai recuparar os dados do bd, pegar os dados do select
        ...
        try {
            ...
            throw new RuntimeException("Erro ao busca os projetos" + ex.getMessage(), ex);
        } finally {
